...
abstract class BaseFriend extends BaseObject  implements Persistent {
	...
	public function setImage($v)
	{
		...
		if ($this->image !== $v) {
			$this->image = $v;
			$this->modifiedColumns[] = FriendPeer::IMAGE;
		}
	...
	public function setBody($v)
	{
		...
		if ($this->body !== $v) {
			$this->body = $v;
			$this->modifiedColumns[] = FriendPeer::BODY;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = FriendPeer::UPDATED_AT;
		}
    ...
    if ($this->isModified() && !$this->isColumnModified(FriendPeer::UPDATED_AT))
    {
		...
		if ($this->collFriendComments === null) {
			if ($this->isNew()) {
			   $this->collFriendComments = array();
				...
				$criteria->add(FriendCommentPeer::FRIEND_ID, $this->getId());
